 ...
 */
class DcpAlarm extends MibBase
{
     ...
     */
    public function getDcpAlarmLogListLocation() : iterable
    {
        return $this->getSnmp()->walkFirstDegree(self::OID_DCP_ALARM_LOG_LIST_LOCATION);
    }
}
